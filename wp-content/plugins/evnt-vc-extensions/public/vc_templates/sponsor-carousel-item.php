...
if (!function_exists('sponsor_carousel_item')) {

    function sponsor_carousel_item($atts, $content = null) {
        ...
        if (!empty($sponsor)) {
            ...
            $output .= $link_open . '<img src="' . $photo[0] . '" class="img-responsive" alt="' . $a_title . '">' . $link_close;
        }
...
add_shortcode('sponsor_carousel_item', 'sponsor_carousel_item');
